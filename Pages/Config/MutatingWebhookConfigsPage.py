...
class MutatingWebhookConfigsPage(BaseResourcePage):
    ...
    def __init__(self, parent=None):
        ...
        self.show_namespace_dropdown = False  # MutatingWebhookConfigurations are cluster-scoped
        self.setup_page_ui()
    ...
    def handle_row_click(self, row, column):
        if column != self.table.columnCount() - 1:  # Skip action column
            ...
            # MutatingWebhookConfigurations are cluster-scoped resources, no namespace needed
            namespace = None
