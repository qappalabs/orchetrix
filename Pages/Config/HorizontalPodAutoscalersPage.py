...
class HorizontalPodAutoscalersPage(BaseResourcePage):
    ...
    def handle_row_click(self, row, column):
        # Skip navigation for interactive columns (checkbox/action button)
        if column == 0 or column == 9:  # Checkbox column or Action button column
            return

        # Skip navigation if the cell contains an interactive widget
