...
class HelmOperationThread(QThread):
    ...
    def is_interrupted(self):
        ...
        return self._is_cancelled or is_shutdown_requested()
...
class ReleaseUpgradeDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.values_editor.setStyleSheet(get_values_editor_style())
        ...
        self.atomic_checkbox.setStyleSheet(get_atomic_checkbox_style())
        ...
        self.upgrade_button.setStyleSheet(get_upgrade_button_style())
