...
# Status colors shown only for conditions with special handling for Available and Progressing.
# """
...
#         # Medium columns (give them some width but not as much as stretch)
#         medium_columns = [3, 4, 5]
...
#         # Add regular columns to the table (these will be normal QTableWidgetItems)
#         columns = [
#             resource["name"],
#             resource["namespace"],
#             pods_str,
...
#             # Default text color for all regular columns
#             item.setForeground(QColor(AppColors.TEXT_TABLE))
            
#             # Add the item to the table
#             self.table.setItem(row, cell_col, item)
            
#         # Special handling for Conditions column - use the StatusLabel widget
#         conditions_color = None
        
#         # Determine the color based on condition types
#         if "Available" in conditions_str:
#             conditions_color = AppColors.STATUS_ACTIVE  # Green
#         elif "Progressing" in conditions_str and "Available" not in conditions_str:
#             conditions_color = AppColors.STATUS_PENDING  # Orange/Yellow
#         elif not conditions_str:
#             conditions_color = AppColors.STATUS_DISCONNECTED  # Red
#             conditions_str = "None"  # Show "None" instead of empty string
            
#         # Create status widget with correct color
#         status_widget = StatusLabel(conditions_str, conditions_color)
