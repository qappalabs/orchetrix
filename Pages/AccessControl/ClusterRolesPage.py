...
class ClusterRolesPage(BaseResourcePage):
    """
    Displays Kubernetes cluster roles with live data and resource operations.
    """

    def __init__(self, parent=None):

        super().__init__(parent)
        self.resource_type = "clusterroles"  # Set resource type for kubectl
        self.show_namespace_dropdown = False  # ClusterRoles are cluster - scoped
        self.setup_page_ui()
    ...
    def populate_resource_row(self, row, resource):
        """
        Populate a single row with cluster role data from live Kubernetes resources
        """
        # Set row height once
        ...
        checkbox_container = self._create_checkbox_container(
            row, resource_name)  # Styling handled by BaseResourcePage
    ...
    def handle_row_click(self, row, column):
        ...
        resource_name = None
        namespace = None  # ClusterRoles are cluster-scoped
