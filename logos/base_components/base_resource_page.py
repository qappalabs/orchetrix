...
from PyQt6.QtWidgets import (
    ...
    QAbstractItemView, QStackedWidget, QHeaderView
)
...
class BaseResourcePage(BaseTablePage):
    ...
    #     """Display a message within the table area while preserving headers"""
    #     if not self.table:
    #         return
    ...
    #     # Show the table to ensure headers are visible
    #     self._show_table_area()
        
    #     # Create and insert empty state row
    #     self._insert_empty_state_row(message_text, description_text, is_error)

    # def _insert_empty_state_row(self, message_text, description_text=None, is_error=False):
    #     """Insert a custom empty state row that spans all columns"""
    #     if not self.table:
    #         return
        
    #     # Add single row for empty state message
    #     self.table.setRowCount(1)
    #     self.table.setRowHeight(0, 200)  # Taller row for the message
        
    #     # Create the empty state widget
    #     empty_widget = self._create_empty_state_widget(message_text, description_text, is_error)
        
    #     # Set the widget to span all columns in the first row
    #     self.table.setCellWidget(0, 0, empty_widget)
        
    #     # Make the widget span across all columns
    #     if self.table.columnCount() > 1:
    #         self.table.setSpan(0, 0, 1, self.table.columnCount())
        
    #     # Disable sorting while showing empty state
    #     self.table.setSortingEnabled(False)

    # def _create_empty_state_widget(self, message_text, description_text=None, is_error=False):
    #     """Create a styled empty state widget for table display"""
    #     container = QWidget()
    ...
    #         icon_label.setStyleSheet("font-size: 48px; color: #E53935;")
    #     else:
    #         icon_label.setText("📋")
    #         icon_label.setStyleSheet("font-size: 48px; color: #9E9E9E;")
    #     icon_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
    #     layout.addWidget(icon_label)
        
    #     # Main message
    #     main_message = QLabel(message_text)
    #     main_message.setAlignment(Qt.AlignmentFlag.AlignCenter)
    #     main_message.setWordWrap(True)
        
    #     message_color = "#E53935" if is_error else "#9E9E9E"
    #     main_message.setStyleSheet(f"""
    #         color: {message_color};
    #         font-size: 18px;
    #         font-weight: bold;
    #         margin: 10px 0;
