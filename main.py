...
try:
    ...
    class MainWindow(QMainWindow):
        ...
        def switch_to_cluster_view(self, cluster_name="docker-desktop"):
            ...
            # Handle page change to ensure data loading
        ...
        def handle_page_change(self, index):
            ...
            if current_widget == self.cluster_view and hasattr(self.cluster_view, 'stacked_widget'):
                ...
                if active_page and hasattr(active_page, 'force_load_data'):
                    active_page.force_load_data()
                elif active_page and hasattr(active_page, 'load_data'):
    ...
    if __name__ == "__main__":
        ...
        # Apply tooltip style to ensure tooltips have white text
