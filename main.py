...
try:
    # Try to apply subprocess patch if available
...
class MainWindow(QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        # Set a flag to prevent further error dialogs
        self._error_shown = True
        
        # Explicitly disconnect from all signals that might trigger errors
        ...
        # Hide terminal panel if visible
        self.hide_terminal_if_visible()
